      ...
      <div class="content-wrapper font-karla max-w-screen-2xl text-base px-10 mx-auto">
        ...
        <main class="">
          <div class="h-[450px] mx-auto mb-4 " /*style={BGStyle2}*/>
            <div
              class=" w-full h-full flex justify-start items-center bg-gray-700 border border-white 
             bg-opacity-50  rounded-xl"
            >
              <div class="relative h-full flex items-center justify-center ml-16">
                <div class="h-[90%] w-1 bg-gradient-to-b from-purple-500 via-green-600 to-white shadow-[0_0_15px_3px_rgba(255,255,255,0.6)] "></div>

                <div class=" absolute top-0 left-1/2 transform -translate-x-1/2 w-3 h-3 border-gray-300 border-2 rounded-full"></div>
                <div class="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-3 h-3 border-gray-300 border-2 rounded-full"></div>
              </div>

              <div class=" mx-24 text-white">
                <div class="">
                  <h1 class="text-5xl md:text-6xl lg:text-[80px] font-bold leading-tight md:leading-snug lg:leading-normal tracking-wide md:tracking-normal lg:tracking-tight">
                ...
                <div class="text-white w-max tracking-wider border-white border-[3px] rounded-md px-5 py-3 text-xl font-bold cursor-pointer hover:text-gray-950 hover:bg-white hover:shadow-[0_0_15px_3px_rgba(255,255,255,0.6)] transition-all duration-300">
          ...
          <div class="flex justify-center items-center my-[100px]">
            ...
            <div class="tuan-sub-label">Featured Mugs</div>
            <div class="tuan-sub-line"></div>
          </div>
          <div class="flex justify-center items-center my-[100px]">
            <div class="tuan-sub-line"></div>
            <div class="tuan-sub-label">More Product</div>
            <div class="tuan-sub-line"></div>
          </div>
        </main>
      </div>
